...
public class PasswordParser extends BaseXmlParser<String> {

    private final static Logger LOGGER = LogManager.getLogger(PasswordParser.class);

    public PasswordParser(File file) {
        super(file);
    }
